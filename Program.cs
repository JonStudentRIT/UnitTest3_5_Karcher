...
namespace UnitTest3_5
{
    /* Class: Node
     * Purpose: Store data needed to identify the current node and the weight and destination of one direction
     * Restrictions: None
     */
    public class Node
    {
        // this node
        int origin;
        // the cost to the next node
        int cost;
        // the destination 
        int destination;
        // the name of the edge
        string name;
        public Node(string n, int o, int c, int d)
        {
            name = n;
            origin = o;
            cost = c;
    ...
    public partial class LinkedList : Form
    {
       ...
       */
        ...
        private void Button1__Click(object sender, EventArgs e)
        {
            ...
            linkedList.AddLast(new Node("Red-DarkBlue", 0, 1, 1));
            linkedList.AddLast(new Node("Red-Grey", 0, 5, 5));
            linkedList.AddLast(new Node("DarkBlue-Yellow", 1, 2, 8));
            linkedList.AddLast(new Node("DarkBlue-LightBlue", 1, 3, 1));
            linkedList.AddLast(new Node("Yellow-Green", 2, 7, 6));
            linkedList.AddLast(new Node("LightBlue-DarkBlue", 3, 1, 1));
            linkedList.AddLast(new Node("LightBlue-Grey", 3, 5, 0));
            linkedList.AddLast(new Node("Purple-Yellow", 4, 2, 1));
            linkedList.AddLast(new Node("Grey-LightBlue", 5, 3, 0));
            linkedList.AddLast(new Node("Grey-Orange", 5, 6, 1));
            linkedList.AddLast(new Node("Orange-Purple", 6, 4, 1));
            linkedList.AddLast(new Node("Green", -1, -1, -1));

            //linkedList.AddLast("Red-DarkBlue");
            //linkedList.AddLast("Red-Grey");
            //linkedList.AddLast("DarkBlue-Yellow");
            //linkedList.AddLast("DarkBlue-LightBlue");
            //linkedList.AddLast("Yellow-Green");
            //linkedList.AddLast("LightBlue-DarkBlue");
            //linkedList.AddLast("LightBlue-Grey");
            //linkedList.AddLast("Purple-Yellow");
            //linkedList.AddLast("Grey-LightBlue");
            //linkedList.AddLast("Grey-Orange");
            //linkedList.AddLast("Orange-Purple");
